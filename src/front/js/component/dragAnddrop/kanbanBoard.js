                ...
                <div className="tasks p-4">
                    <div className="container-fluid">
                        ...
                        <div className="row justify-content-between">
                            <div className="col simple-card my-4 p-4 overflow-hidden text-break">
                                <Column title={"To-do"} projectId={project?.id} username={userInfo?.username} projectTasks={project?.tasks} id={"1s"} />
                            </div>
                            <div className="col simple-card my-4 p-4 overflow-hidden text-break">
                                <Column title={"In Progress"} projectId={project?.id} username={userInfo?.username} projectTasks={project?.tasks} id={"1s"} />
                            </div>
                        </div>
                    </div>
                </div>
