...
export const CreateProject = ({ username, projectCreated }) => {
    ...
    return (
        <div className="mt-5">
            <button type="button" className="form-button mb-5" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                Create new project
            </button>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form className="d-flex flex-column" onSubmit={handleSubmit}>
                                ...
                                <input className="form-input" type="text" name="username" value={form.username} onChange={handleInputChange} placeholder="Description" required />
